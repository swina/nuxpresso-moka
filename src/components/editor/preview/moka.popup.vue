...
<div>
    <div 
        ...
        <div v-if="modal" :class="'absolute top-0 left-0 right-0 bottom-0 min-h-screen min-w-screen ' + doc.popup.css.modal_background + ' opacity-' + doc.popup.css.modal_opacity"></div>
    </div>
