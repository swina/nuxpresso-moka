...
<div >
    <div style="transform:translateY(-50%);top:50%;" class="fixed top-0 z-top left-0 w-10 pl-2 cursor-pointer border shadow-lg rounded-tr-lg rounded-br-lg bg-gray-800 transform flex flex-col pt-2">
        <i class="material-icons text-gray-400 hover:text-blue-400 mb-2" @click="$emit('customize')" title="Edit component">brush</i>

        <i class="material-icons text-gray-400 hover:text-blue-400 mb-2" @click="$emit('reusable')" title="Add component">add</i>
        
        <i class="material-icons text-gray-400 hover:text-blue-400 mb-2" @click="copiedElement=current.entity,$emit('copy',current)" title="Copy element">content_copy</i>
        ...
        <i class="material-icons text-gray-400 hover:text-blue-400 mb-2" @click="$emit('duplicate',current)" title="Duplicate element">file_copy</i>
