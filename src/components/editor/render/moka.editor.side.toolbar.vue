...
<div v-if="current">
     <div class="fixed bottom-0 z-top left-0 cursor-pointer border bg-gray-800 w-full transform flex flex-row px-2 h-10 mb-10 items-center">
        ...
        <div v-if="opened && editor.current.tag != 'document'" class="bg-gray-800 flex flex-row w-full">
            ...
            <!--
            <i v-if="component && !component.hasOwnProperty('slider')" class="material-icons text-gray-400 hover:text-blue-400 ml-6" title="Preview" @click="$emit('preview')">preview</i>

            <i v-if="component && component.hasOwnProperty('slider')" class="material-icons text-gray-400 hover:text-blue-400 ml-6" title="Preview" @click="$emit('slider')">preview</i>
            
            <i class="material-icons text-gray-400 hover:text-blue-400 ml-6" title="Save" @click="$emit('save')">save</i>
            -->
